    ...
    def getWeather(self, request):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Extrae la información que necesitas, por ejemplo, la temperatura actual
                temperatura_actual = datos_tiempo['temperatura_actual']

                # Puedes agregar más lógica aquí para procesar otros datos según tus necesidades
